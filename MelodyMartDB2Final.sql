...
INSERT INTO Users (Username, PasswordHash, Email, FirstName, LastName, Phone, Role, Status)
VALUES
('Admin1', '$2a$10$cUGmfXVc5O78w770Ywg09.VV63TILJdYl/GI1zT5yYWCI5p3eDW.q', 'Admin1@gmail.com', 'Himantha', 'Jayasundara', '0761309690', 'admin', 'active')

INSERT INTO Users (Username, PasswordHash, Email, FirstName, LastName, Phone, Role, Status)
VALUES
('Kaveesha', 'hash6', 'kavee@gmail.com', 'kaveesha', 'Jayasooriya', '0712345678', 'customer', 'pending')

INSERT INTO Users (Username, PasswordHash, Email, FirstName, LastName, Phone, Role, Status)
VALUES
('Raveen', 'hash7', 'ravee@gmail.com', 'raveen', 'Jayalath', '0761309678', 'customer', 'pending')

INSERT INTO Users (Username, PasswordHash, Email, FirstName, LastName, Phone, Role, Status)
VALUES
('Nethmi', 'hash8', 'neth@gmail.com', 'nethmi', 'perera', '076130456', 'customer', 'pending')

INSERT INTO Users (Username, PasswordHash, Email, FirstName, LastName, Phone, Role, Status)
VALUES
('Himashi', 'hash9', 'hima@gmail.com', 'himashi', 'bandara', '071762345', 'customer', 'pending')

INSERT INTO products (ProductName, Description, Price, StockQuantity,CreatedBy, status) 
VALUES 
('Yamaha Acoustic Guitar', 'FG800 Solid Top Acoustic Guitar, Natural', 45000.00, 15,3, 'approved'),
('Casio Digital Piano', 'PX-160 Digital Piano with Stand and Bench', 50000.00, 8,3, 'pending'),
('Mendini Violin', 'MV500 Solid Wood Violin with Bow and Case', 60000.00, 12,4, 'approved'),
('Pearl Drum Set', 'Export Series 5-Piece Drum Set with Cymbals', 230000.00, 5,3, 'pending'),
('Fender Electric Guitar', 'Stratocaster Electric Guitar with Amp Pack', 190000.00, 10,3, 'pending'),
('Yamaha Saxophone', 'YAS-280 Alto Saxophone with Case', 175000.00, 6,4, 'approved'),
('Korg Synthesizer', 'KORG KROSS 2 61-Key Synthesizer Workstation', 200000.00, 4,2, 'discontinued'),
('Shure Microphone', 'SM58-LC Dynamic Vocal Microphone', 30000.00, 20, 3,'approved'),
('Roland Keyboard', 'GO:KEYS 61-Key Music Creation Keyboard', 165000.00, 7, 4,'pending'),
('Gibson Les Paul', 'Les Paul Standard Electric Guitar, Heritage Cherry', 350000.00, 3,2, 'approved'),
('Tama Drum Set', 'Imperialstar 5-Piece Drum Set with Hardware',  200000.00, 4,2, 'discontinued'),
('Bose PA System', 'L1 Pro8 Portable Line Array System', 245000.00, 2, 3,'discontinued');
GO
...
INSERT INTO Orders (OrderNumber, UserID, TotalAmount, FinalAmount, Status)
VALUES
('ORD006', 6, 150000.00, 150000.00, 'pending'),
('ORD007', 7, 55000.00, 55000.00, 'pending'),
('ORD008', 8, 120000.00, 120000.00, 'processing');


INSERT INTO Payments (OrderID,PaymentMethod,Amount,TransactionID,PaymentDate,Status)
VALUES
(6,'bank_transfer',150000.00,'TXN-SL-1006',2025-10-22,'pending'),
(7,'cash_on_delivery',55000.00,'TXN-SL-1007',2025-10-22,'pending'),
(8,'bank_transfer',280000.00,'TXN-SL-1008',2025-10-22,'processing');